...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-card/50 p-1 text-muted-foreground backdrop-blur-sm border border-border/50",
      className
    )}
    {...props}
  />
